...
- Take-profit: `PAIRED_TAKE_PROFIT_ENABLED`, `PAIRED_TP_SPACING_MULTIPLIER` (opening fills are paired with a reduce-only TP one spacing away)
- Market data: `USE_WEBSOCKET` (orderbook/candles/fills over WebSocket with REST fallback)
