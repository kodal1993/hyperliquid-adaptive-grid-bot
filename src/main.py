...
def run() -> None:
    ...
    engine = LiveExecutionEngine(client=client, state_file=cfg.state_file, start_balance=0.0, max_position_notional_usd=cfg.max_position_notional_usd, allow_position_flip=cfg.allow_position_flip, max_notional_per_trade_usd=cfg.max_notional_per_trade_usd, min_notional_usd=cfg.min_notional_usd, min_order_notional_usd=cfg.min_order_notional_usd, dust_position_notional_usd=cfg.dust_position_notional_usd, leverage=cfg.base_leverage, min_order_lifetime_seconds=cfg.min_order_lifetime_seconds, min_reprice_distance_pct=cfg.min_reprice_distance_pct, max_order_ops_per_cycle=cfg.max_order_ops_per_cycle, rate_limit_cooldown_seconds=cfg.rate_limit_cooldown_seconds, rate_limit_deficit_cooldown_seconds_per_request=cfg.rate_limit_deficit_cooldown_seconds_per_request, rate_limit_max_cooldown_seconds=cfg.rate_limit_max_cooldown_seconds, rate_limit_orphan_grace_seconds=cfg.rate_limit_orphan_grace_seconds, maker_fee_rate=cfg.maker_fee_rate, taker_fee_rate=cfg.taker_fee_rate, use_alo_orders=cfg.use_alo_orders, paired_take_profit_enabled=cfg.paired_take_profit_enabled, paired_tp_spacing_multiplier=cfg.paired_tp_spacing_multiplier)
