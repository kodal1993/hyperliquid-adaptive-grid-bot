...
class BotConfig:
    ...
    def from_env(cls) -> "BotConfig":
        ...
        return cls(
            ...
            min_expected_net_profit_fee_multiple=float(os.getenv("MIN_EXPECTED_NET_PROFIT_FEE_MULTIPLE", os.getenv("MIN_NET_PROFIT_FEE_MULTIPLIER", "1.5"))),
            min_net_profit_fee_multiplier=float(os.getenv("MIN_NET_PROFIT_FEE_MULTIPLIER", os.getenv("MIN_EXPECTED_NET_PROFIT_FEE_MULTIPLE", "1.5"))),
