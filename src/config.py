...
class BotConfig:
    ...
    def from_env(cls) -> "BotConfig":
        ...
        cfg = cls(
            ...
            order_notional_usd=float(os.getenv("ORDER_NOTIONAL_USD", os.getenv("MAX_NOTIONAL_PER_TRADE_USD", "20"))),
            max_active_exposure_usd=float(os.getenv("MAX_ACTIVE_EXPOSURE_USD", "110")),
            regrid_threshold_pct=float(os.getenv("REGRID_THRESHOLD_PCT", "0.006")),
            ...
            max_notional_per_trade_usd=float(os.getenv("MAX_NOTIONAL_PER_TRADE_USD", os.getenv("ORDER_NOTIONAL_USD", "24"))),
            ...
            max_position_notional_usd=float(os.getenv("MAX_POSITION_NOTIONAL_USD", "90")),
            ...
            min_reprice_distance_pct=float(os.getenv("MIN_REPRICE_DISTANCE_PCT", "0.003")),
